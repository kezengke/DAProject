...
processDatasetType <- function(dataset_name) {
  ...
  shuffle_types <- list(
    list(name = "Shuffle sample tags", dir = "ShuffleSampleTagDump"),
    list(name = "Shuffle counts in sample", dir = "ShuffleInSampleDump"),
    list(name = "Shuffle counts in taxon", dir = "ShuffleInTaxonDump"),
    list(name = "Shuffle counts table", dir = "ShuffleCountsTDump")
  )
  ...
  # Save plot
  png(paste0(plot_dir, "FractionOfSignificantResults(", dataset_name, ").png"), 
