...
# Manuscript Figure Generation Pipeline (No RNAseq)
# This script runs all analysis and plotting scripts in the correct order
# to generate all figures for the manuscript (excluding RNAseq datasets)
# Uses backup scripts that don't include RNAseq

echo "=========================================="
echo "Starting Manuscript Figure Generation Pipeline (No RNAseq)"
echo "=========================================="
...
Rscript -e "source('backup_scripts/TtestCalculation.R')"
check_success "T-test calculations"

echo "Running Wilcoxon calculations..."
Rscript -e "source('backup_scripts/WilcoxonCalculation.R')"
check_success "Wilcoxon calculations"

echo "Running DESeq2 calculations..."
Rscript -e "source('backup_scripts/DESeq2Calculation.R')"
check_success "DESeq2 calculations"

echo "Running edgeR calculations..."
Rscript -e "source('backup_scripts/edgeRCalculation.R')"
...
Rscript -e "source('backup_scripts/Log10PvPPlots.R')"
...
Rscript -e "source('backup_scripts/ShuffleFourWaysPvalSigCountsBoxplots.R')"
...
Rscript -e "source('backup_scripts/NBResampleWholeTaxonShuffleSampleTagPvalCalculation.R')"
check_success "NB resample shuffle sample tags calculations"

echo "Running NB resample shuffle counts in sample calculations..."
Rscript -e "source('backup_scripts/NBResampleWholeTaxonShuffleInSamplePvalCalculation.R')"
...
Rscript -e "source('backup_scripts/NBResampleWholeTaxonShuffleInTaxonPvalCalculation.R')"
check_success "NB resample shuffle counts in taxon calculations"

echo "Running NB resample shuffle counts table calculations..."
Rscript -e "source('backup_scripts/NBResampleWholeTaxonShuffleCountsTPvalCalculation.R')"
...
Rscript -e "source('backup_scripts/NBResampleWholeTaxonShuffleFourWaysPvalSigCountsBoxPlots.R')"
...
for dataset in RDP dada2 WGS; do
...
echo ""
echo "=========================================="
echo "Manuscript Figure Generation Complete (No RNAseq)!"
echo "=========================================="
echo ""
echo "Generated figures:"
echo "• Log10 P-value comparison plots (3 datasets × multiple files each)"
echo "• Shuffle fraction of significant counts boxplots (3 datasets)"
echo "• NB resample fraction of significant counts boxplots (3 datasets)"
echo ""
echo "All figures are saved in the Plots/ directory structure."
echo ""
echo "Usage:"
echo "  ./run_pipeline.sh              # Run with RNAseq (full pipeline)"
echo "  ./run_pipeline_no_rnaseq.sh    # Run without RNAseq (faster)" 